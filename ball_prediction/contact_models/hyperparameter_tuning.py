...
def bayesian_optimization(model_class, training_class, input_data, input_dim, output_dim):
    param_space = {
...
def population_based_search(model_class, training_class, input_data, input_dim, output_dim):
    def objective(trial):
        # Define parameter search space
        hidden_neurons = trial.suggest_categorical('hidden_neurons', [(32, 64), (64, 128), (128, 256)])
